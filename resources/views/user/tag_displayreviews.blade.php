                    ...
                    <div class="row" id="navtabs_row" style="background-color: #0F0F0F;">
                        <div class="col-md-12 col-sm-12" style="padding-bottom: 20px;padding-left: 0px;padding-right: 0px;">
                            <ul class="nav nav-tabs nav-stacked" id="nav"style="background-color: #0F0F0F;border-bottom: 0px">
                                <li style="margin-top: 20px" role="presentation" id="dash" class="active"><a class="text-centre" style="border-top-width: 0px;border-radius: 25px;border-left-width: 0px;" id="everything" data-toggle="tab" href="#home">Tags</a></li>


                                {{--<li role="presentation" style="margin-top: 20px">--}}

                                <a href="/home" style="display: flex; justify-content: center;text-decoration: none;"> <button style=" margin-top:30px;" class="btn btn-primary ">Back to home</button></a>
